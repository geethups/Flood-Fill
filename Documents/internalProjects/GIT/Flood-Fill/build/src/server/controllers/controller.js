...
var _sendEmailHandler = function _sendEmailHandler(req, res, next) {
    ...
    var htmlContent = '<div style="width: 450px;border: 1px solid #507AAA;height: 250px;text-align: center;' + 'font-family: sans-serif;">' + '<div style="width: 450px;height: 35px;background: #507AAA;color: white;padding-top: 14px;font-size: 18px;">Flood Fill</div>' + '<div><h3 style="color:#167016;">greeting ' + req.body.user + '</h3><h2 style="color:#507AAA;">Welcome to Flood Fill</h2><br/>' + '<p style="font-size:16px;">FloodFill help you to share your thoughts among your colleagues.</p></div></div>';
    var mailOptions = {
